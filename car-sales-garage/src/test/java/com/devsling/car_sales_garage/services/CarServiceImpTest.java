...
import com.devsling.car_sales_garage.services.CarServiceImp;
...
class CarServiceImpTest {
	...
	@Test
	void testSaveCar_ValidRegistrationDate() {
		// mock du CarMapper pour renvoyer car et du CarRepository pour renvoyer
		// savrdCar
		CarRequestDto carRequestDto = new CarRequestDto(1L, "Toyota", "Camry", LocalDate.of(2022, 5, 15), 25000.0,
				FuelType.DIESEL, 15000, TransmissionType.AUTOMATIC, "car1_picture.jpg");
		
		CarResponseDto carResponseDto = new CarResponseDto(1L, "Toyota", "Camry", LocalDate.of(2022, 5, 15), 25000.0,
				FuelType.DIESEL, 15000, TransmissionType.AUTOMATIC, "car1_picture.jpg");
		
		Car car = new Car(1L, "Toyota", "Camry", LocalDate.of(2022, 5, 15), 25000.0, FuelType.DIESEL, 15000,
				TransmissionType.AUTOMATIC, "car1_picture.jpg");
	...
	@Test
	void testSaveCar_InvalidRegistrationDate() {

		CarRequestDto carRequestDto = new CarRequestDto(1L, "Toyota", "Camry", LocalDate.of(2012, 5, 15), 25000.0,
				FuelType.DIESEL, 15000, TransmissionType.AUTOMATIC, "car1_picture.jpg");
	...
	@Test
	void testGetAvailableMakes() {
		List<Car> cars = Arrays.asList(
				new Car(1L, "Toyota", "Camry", LocalDate.of(2022, 5, 15), 25000.0, FuelType.DIESEL, 15000,
						TransmissionType.AUTOMATIC, "car1_picture.jpg"),
				new Car(2L, "Honda", "Civic", LocalDate.of(2020, 9, 10), 18500.0, FuelType.HYBRID, 20500,
						TransmissionType.MANUAL, "car2_picture.jpg"),
				new Car(3L, "Ford", "Mustang", LocalDate.of(2021, 12, 1), 32000.0, FuelType.ELECTRIC, 10000,
						TransmissionType.AUTOMATIC, "car3_picture.jpg"),
				new Car(4L, "Ford", "Mustang", LocalDate.of(2021, 12, 1), 32000.0, FuelType.ELECTRIC, 10000,
						TransmissionType.AUTOMATIC, "car4_picture.jpg"));
	...
	@Test
	void testUpdateCarPicture_CarFound() {
		Long carId = 1L;
	...
	@Test
	void testUpdateCarPicture_CarNotFound() {
		// Arrange
		Long carId = 1L;
		String newPicture = "new_picture_url";
